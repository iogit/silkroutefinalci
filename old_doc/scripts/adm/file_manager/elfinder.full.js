(function($) {
	...
	elFinder.prototype.options = {
		...
		editorCallback : null,
		/* string to cut from file url begin before pass it to editorCallback. variants: '' - nothing to cut, 'root' - cut root url, '../..//./' - string if it exists in the beginig of url  */
		cutURL         : '',
...
elFinder.prototype.view = function(fm, el) {
	...
	*/
	this.mime2class = function(mime) {
		return mime.replace('../default.htm' , ' ').replace(/\./g, '-');
	}
	...
	help : function(fm) {
		...
		this.exec = function() {
			...
			h = '<div class="el-finder-logo"/><strong>'+this.fm.i18n('elFinder: Web file manager')+'</strong><br/>'+this.fm.i18n('Version')+': '+this.fm.version+'<br/>'
				...
				+'<p><strong><a href="../../elrte.org/'+this.fm.options.lang+'/elfinder" target="_blank">'+this.fm.i18n('Donate to support project development')+'</a></strong></p>'
				+ '<p><a href="../../elrte.org/redmine/projects/elfinder/wiki" target="_blank">'+this.fm.i18n('elFinder documentation')+'</a></p>';
			...
			a = '<div class="el-finder-help-std"/>'
				+'<p>'+this.fm.i18n('Javascripts/PHP programming: Dmitry (dio) Levashov, dio_40std42.ru')+'</p>'
				+'<p>'+this.fm.i18n('Python programming, techsupport: Troex Nevelin, troex_40fury.scancode.ru')+'</p>'
				...
				+'<p>'+this.fm.i18n('Dutch localization')+': Kurt Aerts, <a href="../../ilabsolutions.net/default.htm" target="_blank">http://ilabsolutions.net</a></p>'
				...
				+'<p>'+this.fm.i18n('Icons')+': <a href="../../pixelmixer.ru/default.htm" target="_blank">pixelmixer</a>,  <a href="../../www.famfamfam.com/lab/icons/silk/default.htm" target="_blank">Famfam silk icons</a>, <a href="../../www.fatcow.com/free-icons/default.htm" target="_blank">Fatcow icons</a>'+'</p>'
				+'<p>'+this.fm.i18n('Copyright: <a href="../../www.std42.ru/" target="_blank">Studio 42 LTD</a>')+'</p>'
				+'<p>'+this.fm.i18n('License: BSD License')+'</p>'
				+'<p>'+this.fm.i18n('Web site: <a href="../../elrte.org/elfinder/default.htm" target="_blank">elrte.org/elfinder</a>')+'</p>';
			
			s = '<div class="el-finder-logo"/><strong><a href="../../www.eldorado-cms.ru/" target="_blank">ELDORADO.CMS</a></strong><br/>'
...
elFinder.prototype.quickLook.prototype.plugins = {
	...
	swf : new function() {
		...
		this.show = function(ql, f) {
			if (f.hash == ql._hash) {
				ql.ico.hide();
				// ql.media.append('<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="../../download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0/#version=6,0,40,0/default.htm"><param name="quality" value="high" /><param name="movie" value="'+url+'" /><embed pluginspage="../../www.macromedia.com/go/getflashplayer" quality="high" src="'+url+'" type="application/x-shockwave-flash" style="width:100%;height:'+ql.mediaHeight()+'px"></embed></object>')
					// .slideDown(400);
				var e = ql.media.append('<embed pluginspage="../../www.macromedia.com/go/getflashplayer" quality="high" src="'+f.url+'" style="width:100%;height:'+ql.mediaHeight()+'px" type="application/x-shockwave-flash" />'); 
