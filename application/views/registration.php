...
<head>
    <meta charset="utf-8" />
    <title>Contact Us - Multipurpose Responsive HTML5 Themes with Animated Metro Slider | Vencorp</title>
...
<!-- Header Start -->
  <header data-active="contact" class="header-1 mode-1" id="header">
