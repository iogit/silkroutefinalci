  ...
  <div class="vc_history block">
    <div class="container">
      <div class="row"> 
          <div class="col-md-12">
            <h3>Who We Are</h3>
            <p> <img alt="example image" class="vc_right"  src="img/about/logo-about.jpg">
FAIRNESS, TRANSPARENCY & PROFESSIONALISM
I.T. Silk Route is one of the most reputed names in the professional staffing companies in United States. We have helped our clients and our employees to grow with in all major industries. We facilitate direct hire staffing professionals and serve the fortune's most admired companies all across the world. We are based in the fast growing Dallas FortWorth Metropolitan and we’ve been helping companies of all sizes to respond to industry changes in order to stay competitive. Our team of experts is ready to help you come up with a
'Strategy That Delivers'. </p>
    ...
    <div class="wrapper">
      <div class="container">
        ...
        <div class="row" style="padding-top:30px;">
          <div class="col-md-4">
            <div class="vc_services vc_border-orange">
              <div class="icon"> <i class="fa fa-book vc_orange"></i> </div>
              <h3>ACCOUNTING JOBS
</h3>
              <p>Finance </p>
          ...
          <div class="col-md-4">
            <div class="vc_services vc_border-blue">
              <div class="icon"> <i class="fa fa-keyboard-o vc_blue"></i> </div>
              <h3>TECHNOLOGY JOBS
</h3>
          ...
          <div class="col-md-4">
            <div class="vc_services vc_border-red">
              <div class="icon"> <i class="fa fa-user-md vc_red"></i> </div>
              <h3>HEALTH CARE JOBS
</h3>
              <p>Medical </p>
        ...
        <div class="row" style="padding-top:30px;">
          <div class="col-md-4">
            <div class="vc_services vc_border-green">
              <div class="icon"> <i class="fa fa-truck vc_green"></i> </div>
              <h3>LOGISTIC
</h3>
              <p>TRANSPORT</p>
          ...
          <div class="col-md-4">
            <div class="vc_services vc_border-yellow">
              <div class="icon"> <i class="fa fa-credit-card vc_yellow"></i> </div>
              <h3>FINANCE
</h3>
              <p>BANKING </p>
          ...
          <div class="col-md-4">
            <div class="vc_services vc_border-grey">
              <div class="icon"> <i class="fa fa-shopping-cart vc_grey"></i> </div>
              <h3>RETAIL
</h3>
  ...
  <div id="vc_client-about" class="widget block">
    <div class="wrapper">
      <div class="container">
	  	  <div class="vc_client">
    <h4> Our Clients </h4>
