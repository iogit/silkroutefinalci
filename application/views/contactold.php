...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Uzm.Dr.Dinçer Erdinç > İletişim</title>
        ...
        <div class="wrapper">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    <div id="main-col">
                    <div class="kp-map">
                          <!--  <iframe width="100%" scrolling="no" height="400" frameborder="0" src="http://maps.google.com/maps/ms?msa=0&amp;msid=202155445435279877773.0004bd5d16ad3a69014b6&amp;ie=UTF8&amp;t=m&amp;ll=21.031154,105.782976&amp;spn=0.016023,0.025663&amp;z=14&amp;output=embed" marginwidth="0" marginheight="0" class="google-map"></iframe>-->
                            <p>iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi iletisim icerik yazisi </p>
                        </div><!--kp-map-->
                        ...
                        <div class="row-fluid">
                        	...
                        	<div class="span6">                            	
                                <div id="contact-box">
                                    <h2 class="contact-title">İLETİŞİM FORMU!</h2>               
                                       <form id="contact-form" class="clearfix" action="" method="post" />
                                        <p class="input-block clearfix" >
                                            <label class="required" for="contact_name" >İsim (Gerekli):</label>
                                            <input class="valid"  type="text" name="name" id="contact_name" value="" />
                                        </p>
                                        <p class="input-block">
                                            <label class="required" for="contact_email">Email (Gerekli):</label>
                                            <input type="email" class="valid" name="email" id="contact_email" value="" />
                                        </p>
										
									
												
                                    <input type="hidden" id="key" value="1" name="key">
                                   
                                        <p class="textarea-block">                        
                                            <label class="required" for="contact_message">Mesajınız (Gerekli):</label>
                                            <textarea rows="6" cols="80" id="contact_message" name="message"></textarea>
                                        </p>                            
                                        <p class="contact-button clearfix">                    
                                           <!-- <div class="pull-left span3"><input type="submit" class="btn btn-info" name="button" id="button" value="Rezervasyon Yap"/> -->
                            ...
                            <div class="span6">
                            	<div id="contact-info">
                                	<h2 class="contact-title">İLETİŞİM BİLGİLERİ</h2>
                                    <address>
                                        <p><i class="icon-location"></i><span>5512 Adres Bilgileri 666/13</span></p>
                                        <p><i class="icon-mobile"></i><span>+1 800 789 50 12, +1 800 450 6935, +1 800 450 6940</span></p>
                                        <p><i class="icon-envelop"></i><a href="mailto:mail@compname.com">info@dincererdinc.com</a></p>
                                    </address>
                                </div><!--contact-info-->
                            </div><!--span6-->
