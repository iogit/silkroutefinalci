      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            ...
            <h2>Log In<span class="vc_main-color"></span> or  <a href="rPage" class="">Sign Up</a> </h2>
            <p> 
			</p>
            ...
            <form id="login-form" name="login-form" action="l" method="post">
              ...
              <div class="row">
				...
				<div class="row">
				  <div class="col-md-4">
                  <div class="form-group">
                    <label class="control-label" for="contact-form-email">Password<span class="vc_red">*</span></label>
                    <div class="controls">
                       <input  type="password" value="Password:" onfocus="if(this.value=='Password:') this.value='';" size="35" class="required password" id="password" name="password">
                    </div>
                  </div>
                </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="vc_btn" type="submit" id="login" name="login" value="submit">Log In</button>
                  <a class="vc_btn" href="rPage" class="">Sign Up</a>
