...
if($slider==""){
$sqlslider=mysql_query("SELECT * FROM io_slider ORDER BY ioSlider_id");  //or ASC
$commentcounter=mysql_num_rows($sqlslider); //count output amount
$url=base_url();
if($commentcounter>0)  //if there is comment
{
$limit=0;
	while($row=mysql_fetch_array($sqlslider)) //take comments
	{
	if($limit<4){
	$ioSlider_id=$row["ioSlider_id"];
	$ioSlider_name=$row["ioSlider_name"];
	...
	$slider.='
    <li>
                                                    <img src="'.base_url().'placeholders/slider/'.$ioSlider_name.'.jpg" alt="" />
                                                    <div class="ei-title">
                                                        <h2><a href="#">'.$ioSlider_title.'</a></h2>
                                                        <h3>'.$ioSlider_text.'</h3>
                                                    </div>
                                                </li> 
	';
...
//this block grabs the whole list for viewing
if($blog_list_new==""){
$sql=mysql_query("SELECT * FROM io_blog ORDER BY ioBlog_date DESC");  //or ASC
$commentcounter=mysql_num_rows($sql); //count output amount
$url=base_url();
if($commentcounter>0)  //if there is comment
{
$limit=0;
	while($row=mysql_fetch_array($sql)) //take comments
	{
	if($limit<5){
...
$sql=mysql_query("SELECT * FROM io_blog ORDER BY ioBlog_view DESC");  //or ASC
$commentcounter=mysql_num_rows($sql); //count output amount
$url=base_url();
if($commentcounter>0)  //if there is comment
{
		...
		if($ioComment_answer!="")  //if answer is not empty add answer too.
	{
	 $comment_list.='<div class="parent child">
	  ...
	  $lastpostedcomment.='
			                              ...
			                              <li>
                            		<a title="" href="'.base_url().'comment?comid='.$ioComment_id.'">'.$ioComment_titlesub.'</a>
...
$news_listTop="";
if($news_listTop==""){
$sql=mysql_query("SELECT * FROM io_news ORDER BY ioNews_date DESC");  //or ASC
...
$url=base_url();
if($viewgallery==""){
$sql=mysql_query("SELECT * FROM io_gallerypic ORDER BY iogallerypic_date DESC");  //or ASC
$productCount=mysql_num_rows($sql); //count output amount
$url=base_url();
if($productCount>0)
{
...
$url=base_url();
if($viewgalleryvids==""){
$sql=mysql_query("SELECT * FROM io_galleryvid ORDER BY iogalleryvid_date DESC");  //or ASC
$productCount=mysql_num_rows($sql); //count output amount
$url=base_url();
if($productCount>0)
{
...
-webkit-box-shadow: -4px 4px 7px rgba(50, 50, 50, 0.1);
-moz-box-shadow:    -4px 4px 7px rgba(50, 50, 50, 0.1);
box-shadow:         -4px 4px 7px rgba(50, 50, 50, 0.1);
	}
...
box-shadow:         -4px 4px 7px rgba(50, 50, 50, 0.1);
	...
	span{margin:25px;padding:8px 12px;width:150px;background-color:#0066CC;color:#FFFFFF;border:#003366 0px solid;display:block;float:left;text-align:center;}
            	...
            	<div class="row-fluid">
                	<div class="span12">
                    	<nav id="top-nav">
                        	<ul id="main-menu" class="clearfix">
                            	<li class="menu-home-icon current-menu-item">
                                	<a href="<?php echo base_url();?>">Doktor X</a>
                                 <!--   <ul>
						...
						<!--	<div id="mobile-menu">
                            ...
                            <li class="clearfix"><i class="icon-envelope"></i><a href="mailto:kopatheme@gmail.com">kopatheme@gmail.com</a></li>
                        </ul><!--contact-top-->
                        </nav><!--top-nav-->
                ...
                <div class="span12">
                    ...
                    <div id="main-col">
                        ...
                        <div id="isotop-container">
                            ...
                            <div id="pf-items">
                                <article class="element animation" data-category="animation">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-40.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                        <span class="entry-like"><a class="icon-heart-3 entry-icon" href="#"></a>1663 Likes</span>
                                        <a class="pf-name" href="<?php echo base_url();?>portfolio-detail.html">Project Name</a>
                                    </div>                                                
                                </article><!--element-->
                                <article class="element design" data-category="design">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-41.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element illustration" data-category="illustration">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-42.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element photography" data-category="photography">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-43.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element web" data-category="web">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-44.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element logos" data-category="logos">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-45.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element animation" data-category="animation">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-46.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element design" data-category="design">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-47.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element illustration" data-category="illustration">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-48.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element photography" data-category="photography">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-49.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element web" data-category="web">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-50.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element logos" data-category="logos">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-51.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element animation" data-category="animation">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-52.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element design" data-category="design">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-53.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element illustration" data-category="illustration">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-54.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element photography" data-category="photography">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-55.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element web" data-category="web">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-56.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                                ...
                                <article class="element logos" data-category="logos">
                                    <div class="bwWrapper">
                                        <img src="<?php echo base_url();?>placeholders/post-image/post-57.jpg" alt="" />
                                        <a href="<?php echo base_url();?>portfolio-detail.html" class="kp-pf-detail">+</a>
                                    </div>
                                    <div class="pf-info">
                                    	<span class="entry-view"><span class="icon-eye-4 entry-icon"></span>17786 Views</span>
                            ...
                            <div class="pagination clearfix">
                                <ul class="page-numbers clearfix">
                                    <li><a href="#" class="prev page-numbers">Previous</a></li>
                                    <li><a href="#" class="page-numbers">1</a></li>
                                    <li><span class="page-numbers current">2</span></li>
                                    <li><span class="page-numbers dots">…</span></li>
                                    <li><a href="#" class="page-numbers">8</a></li>
                                    <li><a href="#" class="page-numbers">9</a></li>
                                    <li style="margin-right: 0px;"><a class="next page-numbers" href="#">Next</a></li>
                                </ul><!--page-numbers-->
                            </div><!--pagination-->
