...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Uzm.Dr.Dinçer Erdinç > <?php echo $pagetitle; ?></title>
                        ...
                        <div class="row-fluid">
                         ...
                         <!--                           %%%%%%%%%%%%%%%%%%%%%  -->
						               ...
						               <article class="timeline-item standard-post clearfix">
                                                ...
                                                <!--php pop view news details from mysql start-->
												
												<?php echo $details;?>
												
												
                                                <!--php pop view news details from mysql stop-->
							 ...
							 <article class="timeline-item quote-post clearfix">
                                                    ...
                                                    <div class="entry-body clearfix">                                                    
                                                        ...
                                                        <center><span class="quote-name">
														
												<!--<?php echo $from; ?>-->		
												<!--<?php echo $parentid; ?>-->
                                    <h2 class="contact-title">Yorum Gönder !</h2>               
                                    <form id="contact-form" class="clearfix" action="<?= site_url(''.$from.'?id='.$parentid.'&feromon='.$feromon.'');?>" method="post" />
                                        ...
                                        <p class="input-block">
										 ...
										 <p class="input-block clearfix" >
                                            <label class="required" for="contact_name" >Başlık (Gerekli):</label>
                                            <input class="valid"  type="text" name="title" id="contact_title" value="" />
                                        </p>
										
                                    <input type="hidden" id="parentid" value="<?php echo $parentid; ?>" name="parentid">
                                    <input type="hidden" id="from" value="<?php echo $from; ?>" name="from">
                                        <p class="textarea-block">                        
                                            <label class="required" for="contact_message">Yorum (Gerekli):</label>
                                                ...
                                                <article class="timeline-item video-post clearfix">
                                                    ...
                                                    <div class="entry-body clearfix">
                                                        <div class="kp-thumb hover-effect">
                                                            <div class="mask">
                                                                <a href="http://vimeo.com/46163823" rel="prettyPhoto" class="link-detail" data-icon="&#xe022;"><span></span></a>
                                                            </div>
                                                            <img src="<?php echo base_url();?>placeholders/post-image/post-4.jpg" alt="" />
                                                        </div>
                                                        <header>
                                                            <h2 class="entry-title"><a href="#">Video</a></h2>
                                                            <span class="entry-date"><span class="icon-clock-4 entry-icon" aria-hidden="true"></span><span>August 22, 2013</span></span>
                                                            <span class="entry-comment"><span class="icon-bubbles-4 entry-icon" aria-hidden="true"></span><a href="#">20</a></span>
                                                        </header>
                                                        <p>Autem sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tinci  laoreet dolore magna aliquam erat volutpat.Ut wisi enim ad minim veniam, quis nostrud exerci</p>
                                                        <a href="#" class="more-link">Devamı</a>
                                                    </div>
