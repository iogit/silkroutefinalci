...
<body>
    ...
    <div class="navigation">
        ...
        <ul class="main">
            ...
            <li><a href="<?php echo base_url();?>ioc/inventory_add"><span class="icom-box-add"></span><span class="text">Ekle</span></a></li>	
			<li><a href="<?php echo base_url();?>ioc/inventory_edit"><span class="icom-pencil3"></span><span class="text">Düzenle</span></a></li>   
    ...
    <div class="content">
		...
		<div class="tabs">                    
                        <ul>
                            <li><a href="#tabs-1">MAKALELER</a></li>
                            <li><a href="#tabs-2">YORUMLAR</a></li>
                            <li><a href="#tabs-3">RESİM GALERİ</a></li>
                            <li><a href="#tabs-3">VİDEO GALERİ</a></li>
                        </ul>                        
